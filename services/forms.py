...
class TagForm(FlaskForm):
    ...
    new_users = BooleanField('new users')
    ltv = BooleanField('ltv')
    customer_satisfaction = BooleanField('customer satisfaction')
    mind_share = BooleanField('mind share')
    other = BooleanField('other')
    #Key metric
    any_metrics = BooleanField('any_metrics')
    visitors = BooleanField('visitors')
    sales = BooleanField('sales')
    time_on_site = BooleanField('time on site')
    page_rank = BooleanField('page rank')
    performance = BooleanField('performance')
    customer_satisfaction = BooleanField('customer satisfaction')
    conversion_rate = BooleanField('conversion rate')
    content_consumption = BooleanField('content consumption')
    clicks = BooleanField('clicks')
    downloads = BooleanField('downloads')
    email_signup = BooleanField('email signup')
    ...
    blogs = BooleanField('blogs')
    content = BooleanField('content')
    ab_test = BooleanField('ab_test')
    ad_campaigns = BooleanField('ad_campaigns')
    branding = BooleanField('branding')
    copy = BooleanField('copy')
    cta = BooleanField('cta')
    customer_experience = BooleanField('customer_experience')
    email = BooleanField('email')
    facebook = BooleanField('facebook')
    instagram = BooleanField('instagram')
    landing_page = BooleanField('landing_page')
    lead_gen = BooleanField('lead_gen')
    ...
    product = BooleanField('product')
    promotion = BooleanField('promotion')
    public_awareness = BooleanField('public_awareness')
    retargeting = BooleanField('retargeting')
    reviews = BooleanField('reviews')
    segmentation = BooleanField('segmentation')

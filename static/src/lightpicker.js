! function(t, e) {
    ...
    return function(t) {
        ...
        e.Calendar = class {
            ...
            renderMonth(t) {
                ...
                if (this.options.dropdowns.months) {
                    ...
                    for (let i = 0; i < 12; i += 1) {
                        const n = document.createElement("option"),
                            s = new o.DateTime(new Date(t.getFullYear(), i, 1, 0, 0, 0));
                        n.value = String(i), n.text = s.toLocaleString(this.options.lang, {
                            month: "long"
                        }), n.disabled = this.options.minDate && s.isBefore(new o.DateTime(this.options.minDate), "month") || this.options.maxDate && s.isBefore(new o.DateTime(this.options.maxDate), "month"), n.selected = s.getMonth() === t.getMonth(), e.appendChild(n)
                    }
                    ...
                    e.className = n.monthItemName, e.innerHTML = t.toLocaleString(this.options.lang, {
                        month: "long"
                    }), r.appendChild(e)
                }
                if (this.options.dropdowns.years) {
                    ...
                    const i = this.options.dropdowns.minYear,
                        s = this.options.dropdowns.maxYear ? this.options.dropdowns.maxYear : (new Date).getFullYear();
                    if (t.getFullYear() > s) {
                    ...
                    for (let n = s; n >= i; n -= 1) {
                        const i = document.createElement("option"),
                            s = new o.DateTime(new Date(n, 0, 1, 0, 0, 0));
            ...
            renderDay(t) {
                ...
                if (this.datePicked.length <= 1 && this.options.bookedDays.length) {
                    ...
                    const s = this.dateIsBooked(t, i),
                        a = this.dateIsBooked(o, "[]"),
                        r = this.dateIsBooked(t, "(]"),
        ...
        n.Litepicker.prototype.show = function(t = null) {
            ...
            if (this.triggerElement = e, this.options.scrollToDate)

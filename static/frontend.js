$(document).ready(function() {
	...
	$('.audit .audit_problems').click(function(){
		$(this).toggleClass('audit_problems_selected')

		if($('#startup').hasClass("audit_problems_selected")){
			$('#good').addClass('prices_active')
			$('.prices').not('#good').addClass('not_selected')
		} else {
			$('#good').removeClass('prices_active')
			$('.prices').not('#good').removeClass('not_selected')
		}
